...
const ConsultationsPage = () => {
  ...
  const isOfficer = Boolean(user?.roles?.includes('Officer') || user?.roles?.includes('Family Member'));
...
export default withAuth(ConsultationsPage, ['Patient', 'Officer', 'Family Member']);
